...
<a href="https://www.star-history.com/?type=date&repos=chuongmep%2FRevitAddInManager">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=chuongmep/RevitAddInManager&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=chuongmep/RevitAddInManager&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=chuongmep/RevitAddInManager&type=date&legend=top-left" />
 </picture>
</a>